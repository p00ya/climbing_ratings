...
# Read all logbooks in directory "dir".  Logbook filenames are assumed to be in the
# format generated by theCrag, i.e. "climbername-logbook-YYYY-MM-DD.csv".
# Returns a "raw ascents" data frame with columns "ascentId", "route", "climber",
# "tick", "grade" and "timestamp".
